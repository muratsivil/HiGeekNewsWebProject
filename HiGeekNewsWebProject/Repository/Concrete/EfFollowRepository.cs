...
{
    public class EfFollowRepository : EfKernelRepository<Follow>, IFollowRepository
    {
        public EfFollowRepository(ApplicationDbContext applicationDbContext) : base(applicationDbContext)
        {
